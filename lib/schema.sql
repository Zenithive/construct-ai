-- ConstructAI — Full PostgreSQL schema
-- Run this on a fresh database. For existing DBs run migrations/009_billing_and_admin.sql
...
INSERT INTO subscription_plans (name, code, price_monthly, message_limit, features) VALUES

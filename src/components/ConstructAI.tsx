...
import { Upload, CheckSquare, Bell, Settings, User, Search,  Shield, Zap, Menu, X } from 'lucide-react';
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center space-x-2 py-3 sm:py-4 px-1 sm:px-2 border-b-2 font-medium text-sm transition-colors ${
                    activeTab === tab.id
